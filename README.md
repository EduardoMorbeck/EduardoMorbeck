...
Sou Desenvolvedor Full Stack na **Eterno Software Jurídico** desde 2024, atuando na construção de soluções escaláveis, otimização de sistemas legados e integração de **Inteligência Artificial Generativa (LLMs)** em produtos jurídicos. Trabalho com **C# (.NET)** e **Python (FastAPI)** no backend, e **Vue.js**, **TypeScript** e **Astro** no frontend.
...
- **Refatoração de legado**: otimizei sistemas em **Vue.js 2**, melhorando chamadas REST e a renderização de componentes complexos em até **90%**, com impacto direto na experiência do usuário.
- **Relatórios estratégicos**: construí consultas complexas em **PostgreSQL** para geração de relatórios baseados em regras de negócio do produto.
